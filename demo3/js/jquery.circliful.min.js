    ...
    a.fn.circliful = function (b) {
        ...
        return this.each(function () {
            ...
            if (a(this).data("dimension") != undefined) {
                //F = a(this).data("dimension")+"vw"
                F =  $(window).width()*a(this).data("dimension")
            } else {
                //F = c.dimension+"vw"
                F =  $(window).width()*c.dimension
            }
            ...
            if (a(this).data("text") != undefined) {
                ...
                if (a(this).data("type") != undefined) {
                    ...
                    if (i == "half") {
                        ...
                        a(this).find(".circle-text-half").css({"line-height": (F / 1.5) + "px", "font-size": t + "vw"})
                    } else {
